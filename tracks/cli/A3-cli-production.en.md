...
| | [promptfoo/promptfoo](https://github.com/promptfoo/promptfoo) | ⭐⭐⭐⭐⭐ | Running regression tests before promoting a CLI workflow to production | Eval framework, ★ 25k+. See [Stage 7 Eval](../../stages/07-multi-agent-production.en.md#exercise-2-eval) |
