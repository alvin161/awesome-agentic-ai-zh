...
| **Slash Commands / Custom Prompts** | [anthropics/claude-plugins-official](https://github.com/anthropics/claude-plugins-official) | ⭐⭐⭐⭐⭐ | 找官方 plugin 范本 | 官方 plugin marketplace；每个 plugin 内的 commands / skills 是 slash command 范例（★ 35k+） |
